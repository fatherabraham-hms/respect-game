...
export declare const jsonEndpoints: {
    "post /v1/putProposal": boolean;
    "post /v1/getProposal": boolean;
    "post /v1/getProposals": boolean;
    "get /v1/getPeriodNum": boolean;
    "post /v1/getToken": boolean;
    "post /v1/getAward": boolean;
    "post /v1/getRespectMetadata": boolean;
    "post /v1/getRespectContractMt": boolean;
    "get /v1/respectContractMetadata": boolean;
    "get /v1/token/:tokenId": boolean;
    "post /v1/getAwards": boolean;
    "post /v1/getVotes": boolean;
};
export declare const endpointTags: {
    "post /v1/putProposal": never[];
    "post /v1/getProposal": never[];
    "post /v1/getProposals": never[];
    "get /v1/getPeriodNum": never[];
    "post /v1/getToken": never[];
    "post /v1/getAward": never[];
    "post /v1/getRespectMetadata": never[];
    "post /v1/getRespectContractMt": never[];
    "get /v1/respectContractMetadata": never[];
    "get /v1/token/:tokenId": never[];
    "post /v1/getAwards": never[];
    "post /v1/getVotes": never[];
};
